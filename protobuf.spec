...
%package -n libprotobuf3_21_6_0
Summary: Protocol Buffers - Google's data interchange format

%description -n libprotobuf3_21_6_0
Protocol Buffers are a way of encoding structured data in an efficient
yet extensible format. Google uses Protocol Buffers for almost all of
its internal RPC protocols and file formats.

%package -n libprotoc3_21_6_0
Summary: Protocol Buffers - Google's data interchange format

%description -n libprotoc3_21_6_0
Protocol Buffers are a way of encoding structured data in an efficient
yet extensible format. Google uses Protocol Buffers for almost all of
its internal RPC protocols and file formats.

%package -n libprotobuf-lite3_21_6_0
Summary: Protocol Buffers - Google's data interchange format

%description -n libprotobuf-lite3_21_6_0
Protocol Buffers are a way of encoding structured data in an efficient
yet extensible format. Google uses Protocol Buffers for almost all of
its internal RPC protocols and file formats.
...
Requires: gcc-c++
Requires: libprotobuf-lite3_21_6_0 = %{epoch}:%{version}-%{release}
Requires: libprotobuf3_21_6_0 = %{epoch}:%{version}-%{release}
...
%post -n libprotobuf3_21_6_0 -p /sbin/ldconfig
%postun -n libprotobuf3_21_6_0 -p /sbin/ldconfig
%post -n libprotoc3_21_6_0 -p /sbin/ldconfig
%postun -n libprotoc3_21_6_0 -p /sbin/ldconfig
%post -n libprotobuf-lite3_21_6_0 -p /sbin/ldconfig
%postun -n libprotobuf-lite3_21_6_0 -p /sbin/ldconfig

%files -n libprotobuf3_21_6_0
%license LICENSE
%{_libdir}/libprotobuf.so.*

%files -n libprotoc3_21_6_0
%{_libdir}/libprotoc.so.*

%files -n libprotobuf-lite3_21_6_0
