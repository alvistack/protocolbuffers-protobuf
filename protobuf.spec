...
%package -n libprotobuf4_22_5_0
Summary: Protocol Buffers - Google's data interchange format

%description -n libprotobuf4_22_5_0
Protocol Buffers are a way of encoding structured data in an efficient
yet extensible format. Google uses Protocol Buffers for almost all of
its internal RPC protocols and file formats.

%package -n libprotoc4_22_5_0
Summary: Protocol Buffers - Google's data interchange format

%description -n libprotoc4_22_5_0
Protocol Buffers are a way of encoding structured data in an efficient
yet extensible format. Google uses Protocol Buffers for almost all of
its internal RPC protocols and file formats.

%package -n libprotobuf-lite4_22_5_0
Summary: Protocol Buffers - Google's data interchange format

%description -n libprotobuf-lite4_22_5_0
Protocol Buffers are a way of encoding structured data in an efficient
yet extensible format. Google uses Protocol Buffers for almost all of
its internal RPC protocols and file formats.
...
Requires: libprotobuf-lite4_22_5_0 = %{epoch}:%{version}-%{release}
Requires: libprotobuf4_22_5_0 = %{epoch}:%{version}-%{release}
...
%post -n libprotobuf4_22_5_0 -p /sbin/ldconfig
%postun -n libprotobuf4_22_5_0 -p /sbin/ldconfig
%post -n libprotoc4_22_5_0 -p /sbin/ldconfig
%postun -n libprotoc4_22_5_0 -p /sbin/ldconfig
%post -n libprotobuf-lite4_22_5_0 -p /sbin/ldconfig
%postun -n libprotobuf-lite4_22_5_0 -p /sbin/ldconfig

%files -n libprotobuf4_22_5_0
%license LICENSE
%{_libdir}/libprotobuf.so.*

%files -n libprotoc4_22_5_0
%{_libdir}/libprotoc.so.*

%files -n libprotobuf-lite4_22_5_0
