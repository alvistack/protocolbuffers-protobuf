...
%package -n libprotobuf5_27_1_0
Summary: Protocol Buffers - Google's data interchange format

%description -n libprotobuf5_27_1_0
Protocol Buffers are a way of encoding structured data in an efficient
yet extensible format. Google uses Protocol Buffers for almost all of
its internal RPC protocols and file formats.

%package -n libprotoc5_27_1_0
Summary: Protocol Buffers - Google's data interchange format

%description -n libprotoc5_27_1_0
Protocol Buffers are a way of encoding structured data in an efficient
yet extensible format. Google uses Protocol Buffers for almost all of
its internal RPC protocols and file formats.

%package -n libprotobuf-lite5_27_1_0
Summary: Protocol Buffers - Google's data interchange format

%description -n libprotobuf-lite5_27_1_0
Protocol Buffers are a way of encoding structured data in an efficient
yet extensible format. Google uses Protocol Buffers for almost all of
its internal RPC protocols and file formats.
...
Requires: libprotobuf-lite5_27_1_0 = %{epoch}:%{version}-%{release}
Requires: libprotobuf5_27_1_0 = %{epoch}:%{version}-%{release}
...
%post -n libprotobuf5_27_1_0 -p /sbin/ldconfig
%postun -n libprotobuf5_27_1_0 -p /sbin/ldconfig
%post -n libprotoc5_27_1_0 -p /sbin/ldconfig
%postun -n libprotoc5_27_1_0 -p /sbin/ldconfig
%post -n libprotobuf-lite5_27_1_0 -p /sbin/ldconfig
%postun -n libprotobuf-lite5_27_1_0 -p /sbin/ldconfig

%files -n libprotobuf5_27_1_0
%license LICENSE
%{_libdir}/libprotobuf.so.*

%files -n libprotoc5_27_1_0
%{_libdir}/libprotoc.so.*

%files -n libprotobuf-lite5_27_1_0
